...
(function($) {
	...
	function placeMarkerForStore(store, bounds) {
		...
		var ICON = new google.maps.MarkerImage("markers/distributor/"+store.distributor_code+".png", null, null, new google.maps.Point(14, 13));
			...
			if( typeof data == 'string' ) {
				...
				for( var attribute in data ) {
					if( attribute == 'content' ) {
						...
						$elt.attr(attribute, "http://103.195.30.218/etools-apps/foto-store/foto-store-noo/"+store[data[attribute]]);
					}
				}
			}
		})
