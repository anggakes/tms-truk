 ...
 <section class="content-header">
          <h1>
            Client Rate
            <small>List Of Client Rate</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo BASE_URL(); ?>"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="<?php echo BASE_URL()."client_rate"; ?>"><i class="fa fa-dashboard"></i>Client Rate</a></li>
          </ol>
        </section>
   ...
   <section class="content">
          ...
          <div class="box sms box-default color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-table"></i> Table Client Rate</h3>
            </div>
            <div class="box-body">
            ...
            <div id="wrapper-console" class="clearfix">
                <div id="wrapper-search">
                             <form action="<?php echo base_url()."index.php/client_rate" ?>" method="get">
                             <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
                                <input type="text" id="search" name="search" placeholder="Search..."  value="<?php echo $search; ?>" />
                                <input type="submit" id="submit"  value="Search"/>
                                <?php if($search!="")
								{?>
                                <a href="<?php echo base_url()."index.php/client_rate" ?>" id="clear-search">Clear Search</a>
                                <?php } ?>
                             </form>
                </div>
                <div id="wrapper-button" class="clearfix">
					<?php if($data_role[0]['export_client_rate']=='yes'){ ?>
                	<a href="<?php echo base_url()."index.php/client_rate/exportClientRate?search=".$search; ?>" class="button orange-button">
                    	Export Client Rate
                    </a>
					<?php } ?>
                    <?php if($data_role[0]['add_client_rate']=='yes'){ ?>
                    <a id="add-data" class="button green-button">
                    	Add Client Rate
                    </a>
					<?php } ?>
					<?php if($data_role[0]['delete_client_rate']=='yes'){ ?>
                    <a id="delete-data" class="button btn-danger deletelogg">
                    	Delete Client Rate
                    </a>
					<?php } ?>
					<!--<?php if($data_role[0]['import_client_rate']=='yes'){ ?>
           	...
           	<table id="myTable04" class="fancyTable table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th><div class="mid"><div class="check-box-div"><input type="checkbox" name="select_all" id="select_all"></div>ID Client Rate</div></th>
						...
						<th><div class="mid">Rate Status Date</div></th>
						...
						<?php if($data_role[0]['delete_client_rate']=='yes' || $data_role[0]['edit_client_rate']=='yes'){ ?>
						<th><div class="mid">Action</div></th>
						<?php } ?>
                      </tr>
                    </thead>
             		<tbody>
                    <?php foreach($data_client_rate as $data_client_rate) {?>
                    <tr id="data_<?php echo $data_client_rate->id_client_rate; ?>">
                    	<td class="id_client_rate">
						<div style="width:200px;">
						<div class="check-box-div">
						<input type="checkbox" name="id_checkbox[]" class="iCheck-helper toedit checkbox_satuan" value="<?php echo $data_client_rate->id_client_rate; ?>" />
						</div><span><?php echo $data_client_rate->id_client_rate; ?></span></div></td>
						
						<td class="client_id"><?php echo $data_client_rate->client_id; ?></td>
						<td class="client_name"><?php echo $data_client_rate->client_name; ?></td>
						<td class="origin"><?php echo $data_client_rate->origin; ?></td>
						<td class="destination"><?php echo $data_client_rate->destination; ?></td>
						<td class="province"><?php echo $data_client_rate->province; ?></td>
						<td class="vehicle_type"><?php echo $data_client_rate->vehicle_type; ?></td>
						<td class="vehicle_status"><?php echo $data_client_rate->vehicle_status; ?></td>
						<td class="fixed_rate"><?php echo $data_client_rate->fixed_rate; ?></td>
						<td class="period_rate"><?php echo $data_client_rate->period_rate; ?></td>
						<td class="trip_quota"><?php echo $data_client_rate->trip_quota; ?></td>
						<td class="vehicle_rate"><?php echo $data_client_rate->vehicle_rate; ?></td>
						<td class="weight_rate"><?php echo $data_client_rate->weight_rate; ?></td>
						<td class="excess_weight_rate"><?php echo $data_client_rate->excess_weight_rate; ?></td>
						<td class="min_weight"><?php echo $data_client_rate->min_weight; ?></td>
                        <td class="max_weight"><?php echo $data_client_rate->max_weight; ?></td>
						<td class="uow"><?php echo $data_client_rate->uow; ?></td>
						<td class="volume_rate"><?php echo $data_client_rate->volume_rate; ?></td>
						<td class="min_volume"><?php echo $data_client_rate->min_volume; ?></td>
						<td class="uov"><?php echo $data_client_rate->uov; ?></td>
						<td class="currency"><?php echo $data_client_rate->currency; ?></td>
						<td class="drop_destination"><?php echo $data_client_rate->drop_destination; ?></td>
						<td class="drop_rate"><?php echo $data_client_rate->drop_rate; ?></td>
						<td class="drop_charge_after"><?php echo $data_client_rate->drop_charge_after; ?></td>
						<td class="drop_rate_inner"><?php echo $data_client_rate->drop_rate_inner; ?></td>
						<td class="drop_rate_outer"><?php echo $data_client_rate->drop_rate_outer; ?></td>
						<td class="start_valid_date"><?php convert_date($data_client_rate->start_valid_date); ?></td>
						<td class="expired_date"><?php convert_date($data_client_rate->expired_date); ?></td>
						<td class="rate_status"><?php echo $data_client_rate->rate_status; ?></td>
						<td class="remark"><?php echo $data_client_rate->remark; ?></td>
						<td class="created_by"><?php echo $data_client_rate->created_by; ?></td>
						<td class="created_date"><?php echo $data_client_rate->created_date; ?></td>
						<td class="updated_by"><?php echo $data_client_rate->updated_by; ?></td>
						<td class="updated_date"><?php echo $data_client_rate->updated_date; ?></td>
						
						<?php if($data_role[0]['delete_client_rate']=='yes' || $data_role[0]['edit_client_rate']=='yes'){ ?>
						<td><?php if($data_role[0]['delete_client_rate']=='yes'){ ?><a  class="delete_data link_action" id="<?php echo $data_client_rate->id_client_rate; ?>" >Delete</a><?php } ?> | <?php if($data_role[0]['edit_client_rate']=='yes'){ ?><a  id="<?php echo $data_client_rate->id_client_rate; ?>" class="edit_data link_action">Edit</a><?php } ?></td>
						<?php } ?>
					</tr>
                    <?php }?>
                    </tbody>       
	 ...
	 <div class="remodal" data-remodal-id="modal_add" role="dialog" aria-labelledby="modal1Titl aria-describedby="modal1Desc">
	  ...
	  <div>
		<h2 id="modal1Title">Add Client Rate</h2>
				<form role="form" id="form_add_data" method="POST" action="<?php echo base_url()."index.php/client_rate/addClientRate" ?>" enctype="multipart/form-data">
				 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
	...
	<div class="remodal" data-remodal-id="modal_edit" role="dialog" aria-labelledby="modal1Titl aria-describedby="modal1Desc">
	  <button data-remodal-action="close" class="remodal-close" aria-label="Close"></button>
	  <div>
		<h2 id="modal1Title">Edit Client Rate</h2>
				<form role="form" id="form_edit_data" method="POST" action="<?php echo base_url()."index.php/client_rate/editClientRate" ?>" enctype="multipart/form-data">
				 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
              ...
              <div class="box-body">
                ...
                <input type="hidden" class="form-control" name="id_client_rate_update" id="id_client_rate_update">
	...
	<div class="remodal" data-remodal-id="modal_import" role="dialog" aria-labelledby="modal1Titl aria-describedby="modal1Desc">
	  <button data-remodal-action="close" class="remodal-close" aria-label="Close"></button>
	  <div>
		<h2 id="modal1Title">Import Client Rate</h2>
				<form role="form" id="form_import_data" method="POST" action="<?php echo base_url()."index.php/client_rate/importClientRate" ?>" enctype="multipart/form-data">
				 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
              ...
              <div class="box-body">
				 ...
				 <div class="form-group">
                    <p><a target="_blank" href="<?php echo base_url('/files/example-files/import-client_rate.xlsx')?>">Download sample file import client_rate</a></p>
                 </div>
	...
	<div class="remodal" data-remodal-id="modal_delete" role="dialog" aria-labelledby="modal1Titl aria-describedby="modal1Desc">
	  <button data-remodal-action="close" class="remodal-close" aria-label="Close"></button>
	  <div>
		<h2 id="modal1Title">Delete Client Rate</h2>
				<form role="form" id="form_delete_data" method="POST" action="<?php echo base_url()."index.php/client_rate/deleteClientRate" ?>" enctype="multipart/form-data">
				 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
              ...
              <div class="box-body">
				 ...
				 <div class="form-group">
                      <input type="hidden" name="id_client_rate_delete" id="id_client_rate_delete" class="form-control" value="" />
				</div>
	...
	<div class="remodal" data-remodal-id="modal_delete_all" role="dialog" aria-labelledby="modal1Titl aria-describedby="modal1Desc">
	  ...
	  <div>
		<h2 id="modal1Title">Delete Client Rate</h2>
				<form role="form" id="form_selected_delete_data" method="POST" action="<?php echo base_url()."index.php/client_rate/deleteClientRateAll" ?>" enctype="multipart/form-data">
				 <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
              ...
              <div class="box-body">
				 ...
				 <div class="form-group">
                      <input type="hidden" name="id_client_rate_delete_all" id="id_client_rate_delete_all" class="form-control" value="" />
				</div>
  ...
  <script>
			...
			$(".delete_data").click(function(){
				var id = $(this).attr('id');
				var id_client_rate =  $('#data_'+id+' .id_client_rate span').text();
				$("#reference_delete").text("ID:"+id_client_rate)
				$("#id_client_rate_delete").val(id_client_rate);
			});
			...
			$(".edit_data").click(function(){
				...
				$("#id_client_rate_update").val(id_client_rate);
...
$(".deletelogg").on('click', function () {
    ...
    if (ids.length) {
		...
		$("#id_client_rate_delete_all").val(ids);
