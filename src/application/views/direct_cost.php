 ...
 <section class="content-header">
           	...
           	<table id="myTable04" class="fancyTable table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th><div class="mid"><div class="check-box-div"><input type="checkbox" name="select_all" id="select_all"></div>ID Direct Cost</div></th>
                    ...
                    <tr id="data_<?php echo $data_direct_cost->id_direct_cost; ?>">
						...
						</div><span><?php echo $data_direct_cost->id_direct_cost; ?></span></div></td>
						...
						<td class="period_rate"><?php convert_date($data_direct_cost->period_rate); ?></td>
						...
						<td class="start_valid_date"><?php convert_date($data_direct_cost->start_valid_date); ?></td>
						<td class="expired_date"><?php convert_date($data_direct_cost->expired_date); ?></td>
						<td class="rate_status"><?php echo $data_direct_cost->rate_status; ?></td>
  ...
  <script>
			...
			$(".delete_data").click(function(){
				...
				$("#reference_delete").text("ID:"+id_direct_cost)
