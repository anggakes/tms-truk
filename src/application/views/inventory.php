 ...
 <section class="content-header">
          <h1>
			Inventory List
            <small>List Of Inventory List</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="<?php echo BASE_URL(); ?>"><i class="fa fa-dashboard"></i>Home</a></li>
            <li><a href="<?php echo BASE_URL()."inventory_list"; ?>"><i class="fa fa-dashboard"></i>Inventory List</a></li>
          </ol>
        </section>
   ...
   <section class="content">
          ...
          <div class="box sms box-default color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-table"></i> Table Inventory List</h3>
            </div>
            <div class="box-body">
            ...
            <div id="wrapper-console" class="clearfix">
                <div id="wrapper-search">
                             <form action="<?php echo base_url()."index.php/inventory_list/" ?>" method="get">
                             <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
                                <input type="text" id="search" name="search" placeholder="Search..."  value="<?php echo $search; ?>" />
                                <input type="submit" id="submit"  value="Search"/>
                                <?php if($search!="")
								{?>
                                <a href="<?php echo base_url()."index.php/inventory_list" ?>" id="clear-search">Clear Search</a>
                                <?php } ?>
                             </form>
                </div>
                <div id="wrapper-button" class="clearfix">
					<?php if($data_role[0]['export_gr']=='yes'){ ?>
                	<a href="<?php echo base_url()."index.php/inventory_list/exportInventoryList?search=".$search; ?>" class="button orange-button">
            ...
            <div class="grid_4 height400">                  
           	<table id="myTable03" class="fancyTable table table-bordered table-hover">
				 ...
				 <?php foreach($data_inventory_list as $data_inventory_list) {?>
						...
						<td><?php echo $data_inventory_list->stock; ?></td>
						</tr>
