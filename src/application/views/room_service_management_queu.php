 ...
 <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li><a href="<?php echo BASE_URL()."index.php/room_service_management/roomServiceQueu"; ?>"><i class="fa fa-dashboard"></i>Room Workshop Queu</a></li>
          </ol>
        </section>
   ...
   <section class="content">
          ...
          <div class="box sms box-default color-palette-box">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-table"></i> Table Workshop Queu</h3>
            </div>
            <div class="box-body">
            ...
            <div id="wrapper-console" class="clearfix">
                <div id="wrapper-search">
                             <form action="<?php echo base_url()."index.php/room_service_management/roomServiceQueu" ?>" method="get">
                             <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash();?>" />
                                <input type="text" id="search" name="search" placeholder="Search..."  value="<?php echo $search; ?>" />
                                <input type="submit" id="submit"  value="Search"/>
                                <?php if($search!="")
								{?>
                                <a href="<?php echo base_url()."index.php/room_service_management/roomServiceQueu" ?>" id="clear-search">Clear Search</a>
                                <?php } ?>
                             </form>
                </div>
                <div id="wrapper-button" class="clearfix">
                    ...
                    <a href='<?php echo BASE_URL()."index.php/room_service_management"; ?>' class="button green-button">
                    	Add Workshop
                    </a>
					<?php } ?>
              ...
              <div class="box-body">
				...
				<div class="form-group">
					  ...
					  <select class="form-control" name="edit_service_man_power" id="edit_service_man_power" required>
						<option selected="selected" value="">Choose Service Service Man Power</option>
						<option value="self_service">Service By Self</option>
						<option value="vendor_service">Service By Vendor</option>
					  </select> 
				</div>
