...
<html>
  <head>
    ...
    <title>Fipas - <?php echo $title; ?></title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>F</b>PS</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Fi</b>Pass</span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016 <a href="http://elfasolution.co.id/" target="_blank">Elfa Solution</a>.</strong> All rights reserved.
      </footer>
