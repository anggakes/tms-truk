           	...
           	<table id="myTable03" class="fancyTable table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th><div class="check-box-div"><input type="checkbox" name="select_all" id="select_all"></div>ID Absent</th>
                        <th>Vehicle ID</th>
                        <th>Driver Name</th>
						<th>Driver Code</th>
						<th>Date Absence</th>
						<?php if($data_role[0]['delete_truck_absent']=='yes' || $data_role[0]['edit_truck_absent']=='yes'){ ?>
						<th>Action</th>
						<?php } ?>
                      </tr>
                    </thead>
                    ...
                    <tr id="data_<?php echo $data_absent->id_truck_absent; ?>">
                    	<td class="id_truck_absent">
						<div class="check-box-div">
						<input type="checkbox" name="id_checkbox[]" class="iCheck-helper toedit checkbox_satuan" value="<?php echo $data_absent->id_truck_absent; ?>" />
						</div><span><?php echo $data_absent->id_truck_absent; ?></span></td>
						
						
						
                        <td class="vehicle_id"><?php echo $data_absent->vehicle_id; ?></td>
                        <td class="driver_name"><?php echo $data_absent->driver_name; ?></td>
						<td class="driver_code"><?php echo $data_absent->driver_code; ?></td>
						<td class="date_absence"><?php convert_date($data_absent->date_absence); ?>
						<div class='data_detail_truck_absent' style='display:none;'>
						<span class='kelengkapan_oli_mesin'><?php echo $data_absent->kelengkapan_oli_mesin; ?></span>
						<span class='action_kelengkapan_oli_mesin'><?php echo $data_absent->action_kelengkapan_oli_mesin; ?></span> 
						<span class='kecukupan_air_radioator'><?php echo $data_absent->kecukupan_air_radioator; ?></span>
						<span class='action_kecukupan_air_radioator'><?php echo $data_absent->action_kecukupan_air_radioator; ?></span>
						<span class='kondisi_ban'><?php echo $data_absent->kondisi_ban; ?></span>
						<span class='action_kondisi_ban'><?php echo $data_absent->action_kondisi_ban; ?></span>
						<span class='kondisi_accu'><?php echo $data_absent->kondisi_accu; ?></span>
						<span class='action_kondisi_accu'><?php echo $data_absent->action_kondisi_accu; ?></span>
						<span class='kontrol_lampu'><?php echo $data_absent->kontrol_lampu; ?></span>
						<span class='action_kontrol_lampu'><?php echo $data_absent->action_kontrol_lampu; ?></span>
						<span class='angin_untuk_rem'><?php echo $data_absent->angin_untuk_rem; ?></span>
						<span class='action_angin_untuk_rem'><?php echo $data_absent->action_angin_untuk_rem; ?></span>
						<span class='test_mesin'><?php echo $data_absent->test_mesin; ?></span>
						<span class='action_test_mesin'><?php echo $data_absent->action_test_mesin; ?></span>
						<span class='kondisi_body_truck'><?php echo $data_absent->kondisi_body_truck; ?></span>
						<span class='action_kondisi_body_truck'><?php echo $data_absent->action_kondisi_body_truck; ?></span>
						<span class='kecukupan_isi_solar'><?php echo $data_absent->kecukupan_isi_solar; ?></span>
						<span class='action_kecukupan_isi_solar'><?php echo $data_absent->action_kecukupan_isi_solar; ?></span>
						<span class='kelengkapan_safety'><?php echo $data_absent->kelengkapan_safety; ?></span>
						<span class='action_kelengkapan_safety'><?php echo $data_absent->action_kelengkapan_safety; ?></span>
						<span class='kelengkapan_document'><?php echo $data_absent->kelengkapan_document; ?></span>
						<span class='action_kelengkapan_document'><?php echo $data_absent->action_kelengkapan_document; ?></span>
						</div>
						</td>
						
						
						<?php if($data_role[0]['delete_truck_absent']=='yes' || $data_role[0]['edit_truck_absent']=='yes'){ ?>
						<td><?php if($data_role[0]['delete_truck_absent']=='yes'){ ?><a  class="delete_data link_action" id="<?php echo $data_absent->id_truck_absent; ?>" >Delete</a>| <?php if($data_role[0]['edit_truck_absent']=='yes'){ ?><a  id="<?php echo $data_absent->id_truck_absent; ?>" class="edit_data link_action">Edit</a><?php } ?> | 
						<a  id="<?php echo $data_absent->id_truck_absent; ?>" class="detail_data link_action">Detail</a><?php } ?></td>
						<?php } ?>
					</tr>
                    <?php }?>
                    </tbody>       
