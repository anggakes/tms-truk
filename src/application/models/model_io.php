...
class Model_io extends CI_Model{
	...
	public function countIo($search_term=""){
		$this->db->or_like('division_name', $search_term);
		$this->db->or_like('id_io', $search_term);
		return $this->db->get('master_io')->num_rows();
	}
	
	public function dataIo($sampai,$dari,$search_term=""){
		$this->db->or_like('division_name', $search_term);
		$this->db->or_like('id_io', $search_term);
		return $query = $this->db->get('master_io',$sampai,$dari)->result();
