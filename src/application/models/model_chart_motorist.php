...
class Model_chart_motorist extends CI_Model{

	


	public function dataChannelChart($product,$motorist,$date,$code_role,$ket){
		...
		return $query = $this->db->get('channel')->result();
