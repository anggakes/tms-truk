...
class Model_transporter extends CI_Model{
	...
	public function countTransporter($search_term=""){
		$this->db->or_like('transporter_id', $search_term);
		$this->db->or_like('transporter_name', $search_term);
		return $this->db->get('transporter')->num_rows();
	}
	
	public function dataTransporter($sampai,$dari,$search_term=""){
		$this->db->or_like('transporter_id', $search_term);
		$this->db->or_like('transporter_name', $search_term);
		return $query = $this->db->get('transporter',$sampai,$dari)->result();
