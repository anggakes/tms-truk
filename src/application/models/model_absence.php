...
class Model_absence extends CI_Model{
	...
	public function countSummaryAbsenceDriver($search_term=""){
		
		
		$this->db->like('driver.driver_code', $search_term);
		return $this->db->get('driver')->num_rows();
	}
	
	public function dataSummaryAbsenceDriver($sampai,$dari,$search_term=""){
	...
	public function getAbsence($where="")
	{
		...
		public function getAbsencDriver($where="")
	{
		$data = $this->db->query("SELECT * FROM driver_absence ".$where);
		return $data;
		}
