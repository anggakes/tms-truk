		...
		if (!$this->tank_auth->is_logged_in()) {								// not logged in or not activated
			...
			if ($this->form_validation->run()) {								// validation ok
				if ($this->tank_auth->change_password(
						...
						$this->session->set_flashdata('message_success','Password successfully changed!');
				    	redirect('auth/change_password');
				} else {														// fail
					$errors = $this->tank_auth->get_error_message();
					foreach ($errors as $k => $v)	$data['errors'][$k] = $this->lang->line($v);
					//$this->session->set_flashdata('message_failed','Failed to change password, please try again!');
				    	//redirect('account_master/changePassword');
				}
			}
			...
			'content' => $this->load->view('auth/change_password_form',array('data'=>$data),true),
